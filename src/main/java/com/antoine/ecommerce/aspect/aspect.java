package com.antoine.ecommerce.aspect;
...
public class aspect {
    ...
    @Before("execution(* com.antoine.ecommerce.controller.*.*(..))")
    ...
    @Around("execution(* com.antoine.ecommerce.controller.*.*(..))")
    ...
    @AfterReturning(value = "execution(* com.antoine.ecommerce.controller.*.*(..))", returning = "valeurDeRetour")
    ...
    @AfterThrowing(pointcut = "execution(* com.antoine.ecommerce.controller.*.*(..))", throwing = "exception")
    ...
    @After("execution(* com.antoine.ecommerce.controller.*.*(..))")
